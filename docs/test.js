...
/** 총별 스프레이 패턴 (pitch=위 반동, yaw=우측 반동) — 참고: AK 위→우→좌, M4 위→좌→우 */
function buildSpray(entries) {
  return entries.map(([p, y]) => ({ p, y }));
}

const SPRAY_PATTERNS = {
  // Vandal (AK): 수직 상승 → 우측 → 좌측 긴 수평
  vandal: buildSpray([
    [0.015, 0.0], [0.015, 0.0], [0.014, 0.001], [0.014, 0.001], [0.013, 0.002], [0.013, 0.003],
    [0.012, 0.004], [0.012, 0.005], [0.011, 0.007], [0.010, 0.010],
    [0.009, 0.014], [0.008, 0.017], [0.007, 0.019], [0.006, 0.020], [0.005, 0.019],
    [0.004, 0.014], [0.004, 0.008], [0.003, 0.002], [0.003, -0.006], [0.003, -0.012],
    [0.003, -0.018], [0.003, -0.022], [0.003, -0.025], [0.003, -0.026], [0.003, -0.025],
  ]),
  // Phantom (M4): 수직 상승 → 좌측 훅 → 우측 버스트
  phantom: buildSpray([
    [0.012, 0.0], [0.012, 0.0], [0.011, 0.001], [0.011, 0.001], [0.010, 0.002], [0.010, 0.003],
    [0.009, 0.004], [0.009, 0.005], [0.008, 0.006], [0.008, 0.006],
    [0.007, 0.003], [0.006, -0.001], [0.005, -0.005], [0.005, -0.009], [0.004, -0.012],
    [0.004, -0.010], [0.004, -0.005], [0.004, 0.0], [0.004, 0.006], [0.004, 0.011],
    [0.004, 0.015], [0.004, 0.018], [0.004, 0.019], [0.004, 0.018], [0.004, 0.016],
  ]),
